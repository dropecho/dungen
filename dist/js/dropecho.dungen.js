...
dropecho_ds_Graph.prototype = {
	...
	,addUniEdge: function(fromId,toId,data) {
		if(!dropecho_interop_AbstractMap.exists(this.edges,fromId)) {
			dropecho_interop_AbstractMap.set(this.edges,fromId,dropecho_interop_AbstractMap._new());
		}
		dropecho_interop_AbstractMap.set(dropecho_interop_AbstractMap.get(this.edges,fromId),toId,data);
	}
	...
	,edgeData: function(fromId,toId) {
		if(dropecho_interop_AbstractMap.exists(this.edges,fromId)) {
			var edgefrom = dropecho_interop_AbstractMap.get(this.edges,fromId);
			if(dropecho_interop_AbstractMap.exists(edgefrom,toId)) {
				return dropecho_interop_AbstractMap.get(edgefrom,toId);
			}
		}
		return null;
	}
...
dropecho_ds_graph_Search.dijkstra = function(node,distCalc) {
		...
		while(_g3 < fields.length) {
			...
			if(bfIsArray) {
				...
				try {
					...
					console.log("dropecho/interop/Extender.hx:85:","FAILED SETTING PROP: " + ff + " error: " + Std.string(ex1));
				}
			}
		}
	}
